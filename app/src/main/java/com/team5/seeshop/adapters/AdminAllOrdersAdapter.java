...
public class AdminAllOrdersAdapter extends RecyclerView.Adapter<AdminAllOrdersAdapter.ViewHolder> {

    List<PlaceOrderModel> productModelList;
    Context context;
    SharedPreferences sharedPref;
    public AdminAllOrdersAdapter(List<PlaceOrderModel> productModelList, Context context) {
    ...
    @NonNull
    @Override
    public AdminAllOrdersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdminAllOrdersAdapter.ViewHolder holder, int position) {
...
*/
    ...
    public void filterList(List<PlaceOrderModel> filterllist) {
